 ...
 */
let currentHR = 166
//let veryLight: Bool = (currentHR >= 100) && (currentHR <= 120)
//let light: Bool = (currentHR >= 121) && (currentHR <= 140)
//let moderate: Bool = (currentHR >= 141) && (currentHR <= 160)
//let hard: Bool = (currentHR >= 161) && (currentHR <= 180)
//let max: Bool = (currentHR >= 181) && (currentHR <= 200)
...
default:
    print("Your heart rate is too high. Please slow down")
}
/*:
