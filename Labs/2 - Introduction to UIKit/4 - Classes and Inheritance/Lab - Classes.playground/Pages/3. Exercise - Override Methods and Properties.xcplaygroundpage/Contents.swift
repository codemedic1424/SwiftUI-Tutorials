...
defender.moveRight()
print("\(defender.name) position:", defender.position)
defender.fire()
...
print("\(defender.name)'s Shield Strength: \(defender.shieldStrength)")
print("\(defender.name)'s Health: \(defender.health)")
defender.wasHit()
print("\(defender.name)'s Shield Strength: \(defender.shieldStrength)")
print("\(defender.name)'s Health: \(defender.health)")
...
// Testing of superclass wasHit() logic. Test Success!
defender.wasHit()
print("\(defender.name)'s Shield Strength: \(defender.shieldStrength)")
print("\(defender.name)'s Health: \(defender.health)")
defender.wasHit()
