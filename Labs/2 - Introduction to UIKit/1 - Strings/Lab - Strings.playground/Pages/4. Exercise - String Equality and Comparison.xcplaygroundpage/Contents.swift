 ...
 */
let nameInCaps = "Christopher Wilshusen"
let name = "christopher wilshusen"
if name == nameInCaps {
...
if name == nameInCaps.lowercased() {
    print("\(name) and \(nameInCaps.lowercased()) are the same.")
} else {
    print("\(name) and \(nameInCaps.lowercased()) are not the same.")
}
