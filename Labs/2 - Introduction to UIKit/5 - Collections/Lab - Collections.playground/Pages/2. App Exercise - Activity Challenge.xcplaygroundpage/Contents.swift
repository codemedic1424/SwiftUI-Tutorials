 ...
 */
var walkingChallenges = ["Walk 6 miles a week", "Walk a minimum of 30 minutes a day", "Power walk 3 times a week"]
var runningChallenges = ["Run 5k per week", "Run 15k per week", "Run 20k per week"]
var calisthenicsChallenges = ["Yoga 3 times per week", "Yoga 5 times per week", "Yoga 7 times per week"]
...
var userCommitted = ["Yoga 3 times per week", "Run 5k per week", "Walk 3 times per week"]
// Logic Testing Variables:
//var userCommitted = ["Run 10k per week"]
//var userCommitted: [String] = []
...
} else if userCommitted.count == 1 {
    print("The challenge you have chosen is \(userCommitted[0]).")
} else {
