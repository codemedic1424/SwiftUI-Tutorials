...
print("My run so far: Distance: \(firstRun.distance) meters, Time: \(firstRun.time) minutes, and an elevation of \(firstRun.elevation) meters. Not a bad start!")
/*:
