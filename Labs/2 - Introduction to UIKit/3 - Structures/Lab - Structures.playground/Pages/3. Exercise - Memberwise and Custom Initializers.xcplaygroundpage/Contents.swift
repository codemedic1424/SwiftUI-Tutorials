...
let favoriteBook = Book(title: "Moby Dick", author: "Herman Melville", pages: 321, price: 49.99)
print("My favorite book is \(favoriteBook.title). It was written by \(favoriteBook.author). There are \(favoriteBook.pages) pages and only cost $\(favoriteBook.price)!")
/*:
 ...
 */
struct Laptop {
    var screenSize: Int = 13 //inches
    var repairCount: Int = 0 //numbers of repairs
    var yearPurchased: Int
}
let myLaptop = Laptop(yearPurchased: 2018)
let willLaptop = Laptop(screenSize: 15, repairCount: 0, yearPurchased: 2020)
print(myLaptop)
print(willLaptop)
/*:
